    ...
    IOptions<MachineDataOptions> machineDataOptions)
{
    ...
    public async Task<string> GetMachineLogsFromFile()
    {
        ...
        {
            logger.LogWarning("No data found in the machine log file: {FileName}", 
                machineDataOptions.Value.MachineLogFileName);
